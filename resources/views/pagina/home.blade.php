		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				...
				<ul class="full-box list-unstyled text-center">
					...
					<li>
						<a href="{{ route('login') }}" title="Salir del sistema" class="btn-exit-system">
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="{{ route('company') }}"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Empresa</a>
						</li>
						<li>
							<a href="{{ route('category') }}"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Categorías</a>
						</li>
						<li>
							<a href="{{ route('provider') }}"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Proveedores</a>
						</li>
						<li>
							<a href="{{ route('book') }}"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Nuevo libro</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="{{ route('admin') }}"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Administradores</a>
						</li>
						<li>
							<a href="{{ route('client') }}"><i class="zmdi zmdi-male-female zmdi-hc-fw"></i> Clientes</a>
						</li>
					</ul>
				</li>
				<li>
